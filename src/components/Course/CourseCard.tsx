...
const CourseCard: React.FC<CourseCardProps> = ({ name, id }) => {
  return (
    <Link href={`/course/${id}`} passHref>
      <div className="border-[0.75px] border-gray-500 rounded-lg p-3 w-25 text-gray-300 hover:scale-105 transition transform duration-100 ease-out hover:cursor-pointer ">
